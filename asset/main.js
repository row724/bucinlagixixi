...
$(document).ready(function () {
    ...
    // Tanggal dan Waktu
    let ultah = "May 09, 2025 00:00:01";
    ...
    let x = setInterval(function () {
        ...
        if (jarak < 0) {
            ...
            $('.start').click(function () {
                $('.stage1').fadeOut();
                fire_modal('asset/img/cake_modal.png', 'Buat kue ulang tahun kuy!', 'Karena hari ini ayang ulang tahun, pas kalau kamu buat kue ulang tahun secara digital sendiri. Untuk membuat kuenya, mulai dari mengaduk adonan kue yang ayang buat, panggang didalam oven dan terakhir ayang boleh kok hias sesuai keinginan. Oiya, selamat ulang tahun sayangku, semoga kamu suka sama hadiahnya!');
            })
